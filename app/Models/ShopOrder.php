...
//    ];
    ...
    public function getAddTimeAttribute($value)
    {
        ...
        return Carbon::createFromTimestamp(strtotime($value))// Leave this part off if you want to keep the property as
    ...
    public function shopOrderExpress()
    {
        ...
        return $this->hasOne(ShopOrderExpress::class, 'order_id', 'id');
    }
